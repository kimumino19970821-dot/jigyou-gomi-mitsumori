...
const voices = [
  {
    ...
    text: "新店舗のオープン準備で、地域ごとに一般廃棄物の収集業者を探すのが大変でした。立地に合う業者を一括紹介してもらえ、既存店の見直しと合わせて月25万円→18万円に。開業サポートまで心強かったです。",
    before: "25",
    after: "18",
    unit: "万円/月",
    reduction: "28",
  ...
  },
  {
    ...
    text: "長年の付き合いで値上げに応じるしかありませんでした。一括見積で地域の許可業者を比較でき、事業系一般廃棄物のサービス品質そのままで月80万円→56万円に圧縮できました。",
    before: "80",
    after: "56",
    unit: "万円/月",
    reduction: "30",
  ...
  },
  {
    ...
    city: "医療法人／複数クリニック運営",
    text: "感染性廃棄物や医療系産廃の法令対応は必須で不安でした。電子マニフェスト対応業者を紹介してもらえ、内部監査もスムーズ。コストも月35万円→24万円に下がりました。",
    before: "35",
    after: "24",
    unit: "万円/月",
    reduction: "31",
  ...
  },
  {
    title: "食品残渣のリサイクル率向上",
    city: "食品工場／従業員150名規模",
    text: "産廃処分費の高さとリサイクル率の低さが課題でした。リサイクル対応の優良業者とマッチングしてもらい、月120万円→84万円に。SDGs対応の社内報告にも使えています。",
    before: "120",
    after: "84",
    unit: "万円/月",
    reduction: "30",
